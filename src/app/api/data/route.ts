...
const DATA: Item[] = [
  ...
  {
    id: uuidv4(),
    title: 'Cantilever Toolbox ST-350',
    price: 128,
    currency: 'USD',
    company: 'Toyo',
    category: Category.Living,
    image: '/images/cantilever-toolbox.png',
    href: 'https://actualsource.org/products/toyo-cantilever-toolbox-st-350?variant=40465215684706',
  },
  {
    id: uuidv4(),
    title: '4MM Dot Grid Notebook',
    price: 18,
    currency: 'USD',
    company: 'Actual Source',
    category: Category.Workspace,
    image: '/images/4mm-dot-grid-notebook.png',
    href: 'https://actualsource.org/products/4mm-dot-grid-notebook',
  },
  {
    id: uuidv4(),
    ...
    company: 'Actual Source',
    category: Category.Workspace,
    image: '/images/drafting-pencil.png',
    href: 'https://actualsource.org/products/drafting-pencil?variant=40351022284898',
  },
  {
    id: uuidv4(),
    title: 'Stainless Steel Scissors L',
    price: 20,
    currency: 'USD',
    company: 'Penco',
    category: Category.Workspace,
    image: '/images/stainless-steel-scissors.png',
    href: 'https://actualsource.org/products/stainless-steel-scissors-l?variant=40358800556130',
  },
  {
    id: uuidv4(),
    title: 'Basil/Shea Butter Hand Pomade',
    price: 29,
    currency: 'EUR',
    company: 'Le Labo',
    category: Category.Personal,
